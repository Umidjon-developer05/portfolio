				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-10'>
					...
					>
						...
						<ul className='space-y-4'>
							...
							<li>
								...
								<h4 className='text-lg font-medium mt-1'>Shift Academy</h4>
								<p className='text-white/60'>Full Stack Web Development </p>
							</li>
							<li>
								<span className='text-primary'>2025-2026</span>
								<h4 className='text-lg font-medium mt-1'>Rise Academy</h4>
								<p className='text-white/60'>English course</p>
							</li>
						</ul>
					</div>
					...
					>
						...
						<ul className='space-y-4'>
							...
							<li>
								<span className='text-primary'>2023-2024</span>
								<h4 className='text-lg font-medium mt-1'>
									UI/UX Designer & Developer
								</h4>
								<p className='text-white/60'>Freelance Work</p>
							</li>
							<li>
								...
								<p className='text-white/60'>Bukhara Agrocluster & AKT </p>
							</li> 
						</ul>
					</div>
				</div>
